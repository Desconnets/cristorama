document.addEventListener("DOMContentLoaded", () => {
  ...
  const interactions = {
    ...
    commands: {
      ...
      bio: "\nNé pendant le boom internet et issu de la génération Game boy, eMule, iPod et Skyblog, je suis un passionné de pop-culture, de sciences et des techs rétro.\nAujourd'hui, fort de mes sept ans d’expérience en social media management et en relation public, je suis un fin connaisseur des TIC, un explorateur du pixel, un geek de l’info.",
