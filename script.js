document.addEventListener("DOMContentLoaded", () => {
  ...
  const interactions = {
    ...
    commands: {
      ...
      cool: "Après et pendant mes études, j'ai été attiré par la radio, c’est pourquoi je suis un méga fan d’audio et de musique. J’ai commencé comme bénévole chez Radio Campus Montpellier, ou j’ai pu me former au métier du son, notamment en production et technique son.\n \nSuite à cela, avec une bande de potes, nous avons créé en 2017 une radio musicale locale et indépendante, Piñata Radio, dans le style de FIP et Nova.\n \nEn parallèle, avec d’autres passionné.e.s, nous avons créé un collectif : Salut Salut Internet. Une association faites de passionné.e.s de jeux vidéo basée à Montpellier où nous mettons en avant l’univers vidéoludique et la culture pop à travers des événements et des reportages. Depuis peu je collabore avec un agence de production Broadacast, ZQSD, en tant qu’opérateur son avec qui je gère le son, le mixage et le set-up d’émissions sur des plateaux télé pour des steamers et des influenceurs réputés.",
      ...
      contact: "\nDiscutons atour d'une bonne bière ! Tu peux me retrouver à la Barbote, un bar kraft beer à Montpellier !\nSinon tu peux me contacter sur Linkedin en cherchant Cristobal Desconnets.",
