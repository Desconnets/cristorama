document.addEventListener("DOMContentLoaded", () => {
  ...
  const interactions = {
    ...
    commands: {
      ...
      formations:  "\n\nJ’ai une formation de base, scientifique, sauce physique et chimie !\nJ’ai obtenu une licence et un master 1 en sciences du langage, communication, média et médiation numérique à l'institut des sciences du langage de Montpellier à l'UM2.\nJ’ai effectué également plusieurs formations en initiation au web et en montage audio et vidéo. ",
      ...
      expériences: "\n\nMon parcours professionnel s'articule autour de la communication digitale et de la production audiovisuelle, avec une évolution constante vers l'innovation technologique.\n\nActuellement, je collabore avec ZQSD Productions en tant que Consultant Technique & Coordinateur Audiovisuel pour des projets de broadcast en direct et de streaming professionnel depuis 2025.\n\nEn parallèle, je mène des missions de Consultant Communication & Production Audiovisuelle pour le CIRAD (Centre de coopération internationale en recherche agronomique), où je réalise des contenus de vulgarisation scientifique pour des projets internationaux France-Maroc.\n\nDepuis 2021, je suis Content-Manager & Social Media Manager chez Brandie, agence de communication corporate à Montpellier, où je développe des stratégies digitales 360° pour des clients variés du secteur privé et public. Pour en savoir plus sur mes missions, cliquez sur Agence.\n\nMon expérience dans les médias institutionnels s'est forgée en tant que Social Media Manager, Chargé des Partenariats Médias & des Relations Presse au Festival Radio France Montpellier de 2017 à 2021, où j'ai géré la communication d'un événement culturel de rayonnement national. Pour en savoir plus sur mes missions, cliquez sur Radio France.\n\nCette diversité d'expériences me permet aujourd'hui d'allier expertise technique, créativité et vision stratégique dans tous mes projets.",
      projets: "\n\nJe suis dans une agence de com.",
      broadcast: "\n\nAprès et pendant mes études, j'ai été attiré par la radio, c’est pourquoi je suis un méga fan d’audio et de musique. J’ai commencé comme bénévole chez Radio Campus Montpellier, ou j’ai pu me former au métier du son, notamment en production et technique son.\n \nSuite à cela, avec une bande de potes, nous avons créé en 2017 une radio musicale locale et indépendante, Piñata Radio, dans le style de FIP et Nova.\n \nEn parallèle, avec d’autres passionné.e.s, nous avons créé un collectif : Salut Salut Internet. Une association faites de passionné.e.s de jeux vidéo basée à Montpellier où nous mettons en avant l’univers vidéoludique et la culture pop à travers des événements et des reportages.\n\nDepuis peu je collabore avec un agence de production Broadacast, ZQSD, en tant qu’opérateur son avec qui je gère le son, le mixage et le set-up d’émissions sur des plateaux télé pour des streamers et des influenceurs réputés.",
